...
BASE_SC_CAP = BASE_TCB_CAP + MAX_USER_THREADS
BASE_CSPACE_CAP = BASE_SC_CAP + MAX_USER_THREADS
BASE_VSPACE_CAP = BASE_CSPACE_CAP + MAX_USER_THREADS
...
def build_system(
    ...
    for cnode_obj, pd in zip(cnode_objects, system.protection_domains):
        if pd in pds_with_threads:
            num_spawnable_threads = MAX_USER_THREADS - pd.num_child_pds
