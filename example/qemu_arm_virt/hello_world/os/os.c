...
#define VSPACE_STACK_LOW    (VSPACE_STACK_HIGH - libsel4cp_max_threads * 2 * VSPACE_STACK_SIZE)
...
#define VSPACE_IPCBUFF_HIGH (VSPACE_IPCBUFF_LOW + libsel4cp_max_threads * VSPACE_IPCBUFF_SIZE)
